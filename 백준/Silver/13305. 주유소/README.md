...
---
처음으로 서브태스크가 있는 문제를 풀어보았다!   
계속 step 1,2만 통과하고 3를 해결하지 못했다.. 사실 문제는 굉장히 간단했다 😅   
도시까지의 거리와 리터당 가격이 최대 1,000,000,000 까지 주어질 수 있고, 이를 곱셈 연산을 해야하면.. 당연히 결과가 담길 곳이랑 연산되는 수의 자료형이 long은 되어야 함   
우선 연산자의 수가 int의 최대수에 가깝고 곱셈 연산이 들어가는 문제라면 long 자료형에 대한 부분도 염두에 두어야 겠다!   
![image](https://github.com/user-attachments/assets/a7d961c6-0d22-43cc-849b-83bfbc165b88)
> long 자료형 때문인지 메모리랑 시간이 늘어났다 🤣
